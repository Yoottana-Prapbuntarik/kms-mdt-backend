...
from . import views
from .api import BlogAPI, BlogContentViewAPI, BlogContentViewAllAPI, BlogCategoryAPI, BlogDetailAPI, GetBlogCommentViewAPI, BlogCommentAPI, BlogByCategoryItem, DeleteBlog, BlogUpdate, LikeAndUnlikeApi, GetLikeAll, GetLikeByIdApi, GetBlogAllUser
urlpatterns = [
